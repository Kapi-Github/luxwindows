...
function App() {
    ...
    return (
        <div className="w-full flex flex-col gap-[28px] relative box">
            {data ? (
                <GlobalContext.Provider
                    value={{ defaultLanguage, setDefaultLanguage, data }}
                >
                    <div className="max-w-[1260px] w-full mx-auto flex flex-col gap-[28px] bg-white font-[Poppins]">
                        <Header />
                        <Routes>
